...
-keep public class * implements me.zl.mvp.integration.ConfigModule

-keep class com.lex_mung.lawyer_android.mvp.model.entity.** { *; } #实体类不参与混淆
-keep class com.lex_mung.lawyer_android.mvp.ui.widget.** { *; } #自定义控件不参与混淆
...
-keep public class com.lex_mung.lawyer_android.R$*{
