...
import com.lex_mung.client_android.di.component.DaggerReleaseDemandComponent;
...
import com.lex_mung.client_android.mvp.presenter.ReleaseDemandPresenter;
...
public class ReleaseDemandActivity extends BaseActivity<ReleaseDemandPresenter> implements ReleaseDemandContract.View {
    ...
    @OnClick({R.id.view_lawyer_field, R.id.tv_wx, R.id.tv_zfb, R.id.tv_balance, R.id.tv_club_card, R.id.view_discount_way, R.id.tv_fast_consult_tip_1, R.id.bt_pay})
