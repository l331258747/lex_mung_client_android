...
public class EasyDialog {
    ...
    private void initDialog(final Context context) {
        ...
        rlOutsideBackground.setOnTouchListener((v, event) -> {
     ...
     * 点击dialog外部消失的回调
     *
     * @param onDialogDismiss
     */
    public void setOnDialogDismiss(EasyDialog.onDialogDismiss onDialogDismiss) {
     ...
     * @return
     */
    public EasyDialog setVisibility(int visibility) {
        ivTriangle.setVisibility(visibility);
        return this;
    }
     ...
     * @return
     */
    public EasyDialog setCornerRadius(boolean radius) {
        isRadius = radius;
        return this;
    }
    ...
    public EasyDialog setBackgroundColor(int color) {
        ...
        if (drawableRound != null) {
            ...
            if (!isRadius)
                drawableRound.setCornerRadius(0);
        }
        return this;
    }
