...
import com.lex_mung.client_android.di.component.DaggerEquitiesComponent;
...
import com.lex_mung.client_android.mvp.presenter.EquitiesPresenter;
...
import com.lex_mung.client_android.mvp.ui.adapter.EquitiesAdapter;
...
public class EquitiesFragment extends BaseFragment<EquitiesPresenter> implements EquitiesContract.View {
    ...
    private void initAdapter() {
        ...
        equitiesAdapter1.setOnItemClickListener((adapter, view, position) -> {
            ...
            DataHelper.setIntergerSF(mActivity, DataHelperTags.EQUITIES_ID, entity.getOrganizationId());
            DataHelper.setIntergerSF(mActivity, DataHelperTags.EQUITIES_LEVEL_ID, entity.getOrganizationLevelNameId());
            showEquitiesDetails();
