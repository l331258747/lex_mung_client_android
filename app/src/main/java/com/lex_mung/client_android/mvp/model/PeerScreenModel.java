...
@ActivityScope
public class PeerScreenModel extends BaseModel implements PeerScreenContract.Model {
    @Inject
    Gson mGson;
    @Inject
    ...
    @Inject
    public PeerScreenModel(IRepositoryManager repositoryManager) {
    ...
    @Override
    public Observable<BaseResponse<List<PeerScreenEntity>>> getPeerSearchList() {
