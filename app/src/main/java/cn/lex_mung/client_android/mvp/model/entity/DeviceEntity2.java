...
public class DeviceEntity2 {
    ...
    public DeviceEntity2(int device_type, String app_version, int app_version_code,
                         String channel, String device_model, String device_os_version,
                         String device_uuid, String imei,String token,String mobile) {
