...
@ActivityScope
public class HelpStepChildPresenter extends BasePresenter<HelpStepChildContract.Model, HelpStepChildContract.View> {
    @Inject
    ...
    @Inject
    public HelpStepChildPresenter(HelpStepChildContract.Model model, HelpStepChildContract.View rootView) {
