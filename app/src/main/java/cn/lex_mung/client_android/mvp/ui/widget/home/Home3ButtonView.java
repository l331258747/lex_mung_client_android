...
public class Home3ButtonView extends LinearLayout {

    ImageView iv_img,iv_tag;
    TextView tv_title,tv_content1,tv_content2;

    public Home3ButtonView(Context context) {
        this(context,null);
    }

    public Home3ButtonView(Context context, AttributeSet attrs) {
        this(context, attrs,0);
    }

    public Home3ButtonView(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);

        View view = LayoutInflater.from(context).inflate(R.layout.view_home_3button, this, true);
