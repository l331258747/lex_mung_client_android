...
@ActivityScope
public class HelpStepChildModel extends BaseModel implements HelpStepChildContract.Model {
    @Inject
    Gson mGson;
    @Inject
    ...
    @Inject
    public HelpStepChildModel(IRepositoryManager repositoryManager) {
