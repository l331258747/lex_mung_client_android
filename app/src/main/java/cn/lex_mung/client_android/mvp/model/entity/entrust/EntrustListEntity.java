...
public class EntrustListEntity {
    ...
    private List<?> files;
    private List<EntrustListLawyersBean> lawyers;
    ...
    public String getEnrollCount() {
        ...
        return "您的案源已有" + enrollCount + "名律师有接案意向";
    }

    public List<EntrustListLawyersBean> getLawyers() {
        return lawyers;
    }

    public String getPlatformAmountStr() {
    ...
    public void setLawyerAmount(String lawyerAmount) {
    ...
    public String getLMemeberName2() {
        ...
        return lrname + " | " + linstitutionName;
    }
