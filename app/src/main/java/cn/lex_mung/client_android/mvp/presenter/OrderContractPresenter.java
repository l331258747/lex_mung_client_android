...
@ActivityScope
public class OrderContractPresenter extends BasePresenter<OrderContractContract.Model, OrderContractContract.View> {
    @Inject
    ...
    @Inject
    public OrderContractPresenter(OrderContractContract.Model model, OrderContractContract.View rootView) {
        ...
        switch (requestCode) {
            case FILE_SELECT_CODE:
                if (resultCode == Activity.RESULT_OK) {
                    ...
                    // Get the path
                    String path = FileUtils.getPath(mRootView.getActivity(), uri);
    ...
    public void showFileChooser() {
        ...
        try {
            mRootView.getActivity().startActivityForResult(Intent.createChooser(intent, "Select a File to Upload"), FILE_SELECT_CODE);
