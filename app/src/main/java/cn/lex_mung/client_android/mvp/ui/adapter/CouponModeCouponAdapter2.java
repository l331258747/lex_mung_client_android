...
public class CouponModeCouponAdapter2 extends BaseQuickAdapter<ReleaseDemandOrgMoneyEntityCoupon, BaseViewHolder> {

    private int couponId = -1;

    public CouponModeCouponAdapter2() {
    ...
    @Override
    protected void convert(BaseViewHolder helper, ReleaseDemandOrgMoneyEntityCoupon item) {
        ...
        if (item.getCouponStatus() == 1) {//1可使用
            helper.setTextColor(R.id.tv_price, ContextCompat.getColor(mContext,R.color.c_FF7000));
            helper.setTextColor(R.id.tv_price_unit, ContextCompat.getColor(mContext,R.color.c_FF7000));
            helper.setTextColor(R.id.tv_price_tip, ContextCompat.getColor(mContext,R.color.c_FF7000));
            ...
            helper.setTextColor(R.id.tv_price, ContextCompat.getColor(mContext,R.color.c_BFBFC3));
            helper.setTextColor(R.id.tv_price_unit, ContextCompat.getColor(mContext,R.color.c_BFBFC3));
            helper.setTextColor(R.id.tv_price_tip, ContextCompat.getColor(mContext,R.color.c_BFBFC3));
