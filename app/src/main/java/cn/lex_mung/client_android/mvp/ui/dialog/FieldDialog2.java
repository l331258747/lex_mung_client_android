...
import cn.lex_mung.client_android.mvp.ui.adapter.PersonalHomePageFieldDialogAdapter2;
 ...
 * 擅长领域对话框
 */
public class FieldDialog2 extends Dialog {

    private ImageLoader mImageLoader;
    private ExpertPriceSolutionEntity bean;

    public FieldDialog2(@NonNull Context context, ExpertPriceSolutionEntity bean, ImageLoader mImageLoader) {
    ...
    private void initView() {
        ...
        PersonalHomePageFieldDialogAdapter2 fieldDialogAdapter = new PersonalHomePageFieldDialogAdapter2(bean.getChild());
