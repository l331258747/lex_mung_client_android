...
import cn.lex_mung.client_android.mvp.model.entity.expert.ExpertPriceSolutionChildEntity;
import cn.lex_mung.client_android.mvp.model.entity.expert.ExpertPriceSolutionEntity;
import me.zl.mvp.utils.AppUtils;

public class PersonalHomePageFieldDialogAdapter2 extends BaseQuickAdapter<ExpertPriceSolutionChildEntity, BaseViewHolder> {

    public PersonalHomePageFieldDialogAdapter2(List<ExpertPriceSolutionChildEntity> list) {
        super(R.layout.item_personal_home_page_field_dialog, list);
    }

    @Override
    protected void convert(BaseViewHolder helper, ExpertPriceSolutionChildEntity item) {
